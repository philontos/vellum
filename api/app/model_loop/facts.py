...
_FACT_DEF = (
    ...
    "- NOT CURRENT STATE: Current state belongs in state snapshots, not the durable "
    "fact board. Do not add temporary emotions, doubts, intentions, energy levels, "
    "or tentative plans as durable facts. Keep only a genuinely durable anchor or a "
    "time-bounded event that will still be useful later.\n"
